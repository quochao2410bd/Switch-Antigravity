...
process_fixture = [
    {
        ...
        "CommandLine": r'"C:\Users\<USER>\AppData\Local\Programs\antigravity\Antigravity.exe"'
    },
    {
        "ProcessId": 10001,
        ...
        "Name": "Antigravity.exe",
        "Role": "GPU Process",
        "CommandLine": r'"C:\Users\<USER>\AppData\Local\Programs\antigravity\Antigravity.exe" --type=gpu-process --user-data-dir="C:\Users\<USER>\AppData\Roaming\Antigravity"'
    },
    {
        "ProcessId": 10002,
        "ParentProcessId": 10000,
        ...
        "CommandLine": r'"C:\Users\<USER>\AppData\Local\Programs\antigravity\Antigravity.exe" --type=utility --utility-sub-type=network.mojom.NetworkService --user-data-dir="C:\Users\<USER>\AppData\Roaming\Antigravity"'
    },
    {
        "ProcessId": 10003,
        "ParentProcessId": 10000,
        ...
        "CommandLine": r'"C:\Users\<USER>\AppData\Local\Programs\antigravity\Antigravity.exe" --type=renderer --user-data-dir="C:\Users\<USER>\AppData\Roaming\Antigravity" --app-path="C:\Users\<USER>\AppData\Local\Programs\antigravity\resources\app.asar"'
    },
    {
        "ProcessId": 10004,
        "ParentProcessId": 10000,
...
positive_quota = (
    "ERROR: logging before google.Init: I0826 12:00:00.000000   99999 run.go:367] Run: attempt 1 failed (RESOURCE_EXHAUSTED (code 429): Individual quota reached. Please upgrade your subscription to increase your limits. Resets in 3h24m54s.), retrying in 1s\n"
...
neg_generic = (
    "ERROR: logging before google.Init: E0826 12:00:00.000000   99999 run.go:100] RPC failed: RESOURCE_EXHAUSTED: Server side worker capacity temporarily exhausted.\n"
    "ERROR: logging before google.Init: E0826 12:00:05.000000   99999 run.go:100] Backend out of memory: RESOURCE_EXHAUSTED.\n"
)
with open(os.path.join(fixtures_dir, "quota_negative_generic_resource_exhausted.txt"), "w", encoding="utf-8") as f:
    f.write(neg_generic)

neg_429 = (
    "ERROR: logging before google.Init: I0826 12:00:00.000000   99999 http_helpers.go:100] HTTP 429 Too Many Requests: Rate limit exceeded (15 requests per minute).\n"
    "ERROR: logging before google.Init: E0826 12:00:05.000000   99999 errorreport.go:50] 429 concurrency limit reached, backing off.\n"
)
with open(os.path.join(fixtures_dir, "quota_negative_429_other.txt"), "w", encoding="utf-8") as f:
    f.write(neg_429)

neg_503 = (
    "ERROR: logging before google.Init: E0826 12:00:05.000000   99999 errorreport.go:223] agent executor error: calling model: RESOURCE_EXHAUSTED (code 503): Individual quota reached. Please upgrade your subscription to increase your limits. Resets in 1h.\n"
)
with open(os.path.join(fixtures_dir, "quota_negative_code_503.txt"), "w", encoding="utf-8") as f:
    f.write(neg_503)

neg_normal = (
    "ERROR: logging before google.Init: I0826 12:00:00.000000       1 server.go:1478] Starting language server process with pid 10004\n"
    "ERROR: logging before google.Init: I0826 12:00:01.000000       1 server.go:590] Language server listening on random port at 58861 for HTTPS (gRPC)\n"
    "ERROR: logging before google.Init: I0826 12:00:02.000000       1 http_helpers.go:246] URL: https://daily-cloudcode-pa.googleapis.com/v1internal:loadCodeAssist Trace: 0xTRACE_SYNTH_001\n"
)
with open(os.path.join(fixtures_dir, "quota_negative_normal_log.txt"), "w", encoding="utf-8") as f:
    f.write(neg_normal)

host_bridge = (
    "[2026-08-26 12:00:00.000] [info] Starting app (v2.10.0) with dynamic port.\n"
    "[2026-08-26 12:00:00.100] [info] Host bridge server listening on http://127.0.0.1:58860\n"
    r'[2026-08-26 12:00:00.200] [info] Spawning: C:\Users\<USER>\AppData\Local\Programs\antigravity\resources\bin\language_server.exe --standalone --override_ide_name antigravity --subclient_type hub --override_ide_version 2.10.0 --override_user_agent_name antigravity --https_server_port 0 --csrf_token <REDACTED_CSRF_TOKEN> --app_data_dir antigravity --api_server_url https://generativelanguage.googleapis.com --cloud_code_endpoint https://daily-cloudcode-pa.googleapis.com --enable_sidecars --host_bridge_url=http://127.0.0.1:58860 --host_bridge_token=<REDACTED_HOST_BRIDGE_TOKEN>' + "\n"
    "[2026-08-26 12:00:01.000] [info] [Auto-Restart] Port changed! Reloading all windows with URL: https://127.0.0.1:58861/\n"
)
with open(os.path.join(fixtures_dir, "sample_host_bridge_log.txt"), "w", encoding="utf-8") as f:
    f.write(host_bridge)

sse_log = (
    "ERROR: logging before google.Init: I0826 12:00:00.000000   99999 http_helpers.go:246] URL: https://daily-cloudcode-pa.googleapis.com/v1internal:streamGenerateContent?alt=sse Trace: 0xTRACE_SYNTH_001 ResponseID: RESPONSE_SYNTH_001\n"
    "ERROR: logging before google.Init: I0826 12:00:01.000000   99999 http_helpers.go:246] URL: https://daily-cloudcode-pa.googleapis.com/v1internal:streamGenerateContent?alt=sse Trace: 0xTRACE_SYNTH_002 ResponseID: RESPONSE_SYNTH_002\n"
)
...
proto_fixture = {
    "schema_note": "REVERSE_ENGINEERED_RUNTIME_MAPPING from agyhub_summaries_proto.pb",
...
cross_corr = {
    "local_four_way_correlation": {
        "evidence_class": "VERIFIED_LIVE_RUNTIME",
        "matching_conversations_count": 9,
        "total_conversations_count": 9,
        "sources": [
            r"sqlite_db_filename (%USERPROFILE%\.gemini\antigravity\conversations\<cascade_id>.db)",
            "sqlite_trajectory_meta_table (cascade_id column)",
            r"brain_directory (%USERPROFILE%\.gemini\antigravity\brain\<cascade_id>\)",
            "proto_summaries_index (agyhub_summaries_proto.pb Field 17 Subfield 6, REVERSE_ENGINEERED_RUNTIME_MAPPING)"
        ],
    ...
    "active_cdp_correlation": {
        "evidence_class": "VERIFIED_LIVE_RUNTIME",
        "eligible_conversation_page_targets_count": 1,
        "matched_page_targets_count": 1,
...
print("Generated all sanitized fixtures successfully.")
